...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function generateColor(): ColorRGB {
      ...
      // Hue range 0.5 to 0.85 covers cyan, blue, indigo, purple, magenta (contrasts orange theme)
    ...
    const handleFirstMouseMove = (e: MouseEvent) => {
      ...
      parent.removeEventListener('mousemove', handleFirstMouseMove);
    };
    ...
    const handleFirstTouchStart = (e: TouchEvent) => {
      ...
      parent.removeEventListener('touchstart', handleFirstTouchStart);
    };
    ...
    parent.addEventListener('mousemove', handleFirstMouseMove);
    parent.addEventListener('mousemove', handleMouseMove);
    parent.addEventListener('touchstart', handleFirstTouchStart);
  ...
  return (
    <canvas ref={canvasRef} id="fluid" className="absolute inset-0 z-0 pointer-events-none w-full h-full block" />
  );
}
